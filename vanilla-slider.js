...
function VanillaSlider(containerId) {
  ...
  this.images.forEach(function (image, index) {
    ...
    //imageElement.style.maxWidth = '900px';
	imageElement.style.width = '900px';
    ...
    if (index === _this.images.length - 1) {
      imageElement.onload = function () {
        ...
        _this.container.style.width = '900px';
        _this.container.style.height = '700px';
		
        _this.container.style.width = '800px';		
        _this.container.style.height = '700px';
      };
    }
